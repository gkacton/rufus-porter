info <- c(
  "<b>Rufus Porter</b> was born in West Boxford, Massachusetts in 1792. 
  ...
  "<b>Jonathan D. Poor</b> was born in Sebago, Maine in 1807. It is likely that
  ...
  "<b>The Rufus Porter School</b> is the term applied to un-signed murals 
  ...
  "<b>E.J. Gilbert</b> was a painter of Porter School murals. There is no 
...
artist_info %>% write_csv("art-map/data/artist_info.csv")
